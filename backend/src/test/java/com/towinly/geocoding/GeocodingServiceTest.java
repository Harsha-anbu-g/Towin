package com.towinly.geocoding;

import com.towinly.geocoding.dto.GeoResult;
...
class GeocodingServiceTest {
    ...
    private GeocodingService serviceReturning(Object body) {
        ...
        return new GeocodingService(client, "Towinly-Test/1.0");
    }
    ...
    private static class UriCapturingService {
        ...
        static UriCapturingService returning(Object body) {
            ...
            return new UriCapturingService(new GeocodingService(client, "Towinly-Test/1.0"), uriSpec, responseSpec);
        }
    }
}
