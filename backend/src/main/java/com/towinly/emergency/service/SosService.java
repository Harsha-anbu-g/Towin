package com.towinly.emergency.service;
...
import com.towinly.emergency.security.SosRateLimiter;
...
public class SosService {
    ...
    public void sendInactivityAlert(User elder) {
        ...
        contacts.forEach(contact -> sendSms(contact.getPhone(),
                "Your contact on Towinly has not been active for " + INACTIVITY_DAYS +
                " days. Please check in on them."));
        recordFamilyAlert(elder.getId(), () -> elder,
                FamilyAlertType.INACTIVITY,
                "Has not been active on Towinly for " + INACTIVITY_DAYS + " days. A check-in may help.");
    }
