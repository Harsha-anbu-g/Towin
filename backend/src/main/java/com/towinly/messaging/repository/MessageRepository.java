package com.towinly.messaging.repository;
...
public interface MessageRepository extends JpaRepository<Message, UUID> {
    ...
    Page<Message> findByConnectionIdAndChannelOrderByCreatedAtDesc(
            UUID connectionId, com.towinly.common.enums.MessageChannel channel, Pageable pageable);
    long countByConnectionIdAndSeenAtIsNull(UUID connectionId);
    long countByConnectionId(UUID connectionId);
    long countByConnectionIdAndChannel(UUID connectionId, com.towinly.common.enums.MessageChannel channel);
    ...
    java.util.List<Object[]> findLatestByConnectionIds(
            ...
            @Param("channel") com.towinly.common.enums.MessageChannel channel);
